...
def test_internal_symmetric_donor_rank_flip_documents_adapter_boundary():
    """The record lacks ligand-atom orbits, so donor-rank flips are not free.

    This is a bounded negative control, not a desired invariance test.  It
    prevents the manuscript from claiming arbitrary internal donor relabeling
    until the adapter supplies canonical atom-mapped ligand graphs.
    """
    ligand_ids = ["E0", "E1", "E2"]
    base_relations = [
        ("E0", 1, "E1", 2),
